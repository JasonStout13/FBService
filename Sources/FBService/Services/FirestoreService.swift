...
public struct QueryItem {
    ...
    public init(_ key: String, _ type: QueryItemType, _ value: Any) {
        self.key = key
        self.type = type
        self.values = [value]
    }
    
    public init(_ key: String, _ type: QueryItemType, _ values: [Any]) {
        self.key = key
        self.type = type
        self.values = values
    }
...
public struct QueryPagedLimit {
    ...
    public init(limit: Int, orderBy: String, descending: Bool, lastDocumentSnapshot: Binding<DocumentSnapshot?>) {
        self.limit = limit
...
public struct QueryLimit {
    ...
    public init(limit: Int, orderBy: String, descending: Bool) {
        self.limit = limit
        self.orderBy = orderBy
        self.descending = descending
    }
